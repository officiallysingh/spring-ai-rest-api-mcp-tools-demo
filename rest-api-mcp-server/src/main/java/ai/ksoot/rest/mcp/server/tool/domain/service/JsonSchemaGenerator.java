...
//
/// **
// * Utilities to generate JSON Schemas from Java types and method signatures. It's designed to work
// * well in the context of tool calling and structured outputs, aiming at ensuring consistency and
// * robustness across different model providers.
// *
// * <p>Metadata such as descriptions and required properties can be specified using one of the
// * following supported annotations:
// *
// * <p>
// *
// * <ul>
// *   <li>{@code @ToolParam(required = ..., description = ...)}
// *   <li>{@code @JsonProperty(required = ...)}
// *   <li>{@code @JsonClassDescription(...)}
// *   <li>{@code @JsonPropertyDescription(...)}
// *   <li>{@code @Schema(required = ..., description = ...)}
// *   <li>{@code @Nullable}
// * </ul>
// *
// * <p>If none of these annotations are present, the default behavior is to consider the property
// as
// * required and not to include a description.
// *
// * <p>
// *
...
//
//  /**
//   * To ensure consistency and robustness across different model providers, all properties in the
//   * JSON Schema are considered required by default. This behavior can be overridden by setting
// the
//   * {@link ToolParam#required()}, {@link JsonProperty#required()}, or {@link
//   * Schema#requiredMode()}} annotation.
//   */
...
//    }
//    if (Stream.of(schemaOptions)
//        .anyMatch(option -> option == SchemaOption.UPPER_CASE_TYPE_VALUES)) {
//      convertTypeValuesToUpperCase(schema);
//    }
//  }
//
//  /**
//   * Determines whether a property is required based on the presence of a series of * annotations.
//   *
//   * <p>
//   *
//   * <ul>
//   *   <li>{@code @ToolParam(required = ...)}
//   *   <li>{@code @JsonProperty(required = ...)}
//   *   <li>{@code @Schema(required = ...)}
//   *   <li>{@code @Nullable}
//   * </ul>
//   *
//   * <p>If none of these annotations are present, the default behavior is to consider the *
// property
//   * as required.
//   */
...
//   *
//   * <ul>
//   *   <li>{@code @ToolParam(description = ...)}
//   *   <li>{@code @JsonPropertyDescription(...)}
//   *   <li>{@code @Schema(description = ...)}
//   * </ul>
//   *
//   * <p>
//   */
