package ai.ksoot.rest.mcp.server.common.util.rest.response;

import ai.ksoot.rest.mcp.server.common.util.rest.response.builder.AbstractResponseBuilder;
import ai.ksoot.rest.mcp.server.common.util.rest.response.builder.BodyBuilder;
import ai.ksoot.rest.mcp.server.common.util.rest.response.builder.HeaderBuilder;
import ai.ksoot.rest.mcp.server.common.util.rest.response.builder.StatusBuilder;
import java.net.URI;
