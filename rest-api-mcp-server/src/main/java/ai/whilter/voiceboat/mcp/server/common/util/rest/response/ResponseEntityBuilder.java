package ai.whilter.voiceboat.mcp.server.common.util.rest.response;

import ai.whilter.voiceboat.mcp.server.common.util.rest.response.builder.AbstractResponseBuilder;
import ai.whilter.voiceboat.mcp.server.common.util.rest.response.builder.BodyBuilder;
import ai.whilter.voiceboat.mcp.server.common.util.rest.response.builder.HeaderBuilder;
import ai.whilter.voiceboat.mcp.server.common.util.rest.response.builder.StatusBuilder;
import java.net.URI;
