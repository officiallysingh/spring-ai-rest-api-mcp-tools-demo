package ai.whilter.voiceboat.mcp.server.tool.adapter.controller;

import static ai.whilter.voiceboat.mcp.server.tool.domain.ApiToolMappers.API_TOOLS_LIST_TRANSFORMER;
import static org.springframework.hateoas.server.mvc.WebMvcLinkBuilder.linkTo;
import static org.springframework.hateoas.server.mvc.WebMvcLinkBuilder.methodOn;

import ai.whilter.voiceboat.mcp.server.common.util.GeneralMessageResolver;
import ai.whilter.voiceboat.mcp.server.common.util.pagination.PaginatedResource;
import ai.whilter.voiceboat.mcp.server.common.util.pagination.PaginatedResourceAssembler;
import ai.whilter.voiceboat.mcp.server.common.util.rest.response.APIResponse;
import ai.whilter.voiceboat.mcp.server.tool.domain.ApiToolMappers;
...
import ai.whilter.voiceboat.mcp.server.tool.domain.model.ApiToolResponse;
import ai.whilter.voiceboat.mcp.server.tool.domain.service.ApiToolService;
import ai.whilter.voiceboat.mcp.server.tool.domain.service.OpenApiSpecParser;
