package ai.whilter.voiceboat.mcp.server.common.config.web;

import ai.whilter.voiceboat.mcp.server.common.CommonConstants;
import ai.whilter.voiceboat.mcp.server.common.config.SpringProfiles;
import ai.whilter.voiceboat.mcp.server.common.util.ClassUtils;
import ai.whilter.voiceboat.mcp.server.common.util.DateTimeUtils;
...
public class AppInitializer {
  ...
  private static void logApplicationStartup(
    ...
    boolean problemHandling =
        isProblemEnabled && ClassUtils.isPresent("ai.whilter.problem.core.Problem");
