...
- Two weather-related tools:
  ...
  - Get weather alerts by US airShop
...
### Weather Alerts Tool
- Name: `getAlerts`
- Description: Get weather alerts for a US airShop
- Parameters:
  - `airShop`: String - Two-letter US airShop code (e.g., CA, NY)
...
public class WeatherService {
    ...
    @Tool(description = "Get weather alerts for a US airShop. Input is Two-letter US airShop code (e.g., CA, NY)")
    public String getAlerts(String airShop) {
        // Implementation using weather.gov API
    }
}
```
