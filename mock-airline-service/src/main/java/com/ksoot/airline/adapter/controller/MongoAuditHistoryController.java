...
import static com.ksoot.airline.common.CommonConstants.DEFAULT_PAGE_SIZE;
import static com.ksoot.airline.common.util.rest.ApiConstants.INTERNAL_SERVER_ERROR_EXAMPLE_RESPONSE;

import com.ksoot.airline.common.mongo.AuditEvent;
import com.ksoot.airline.common.util.pagination.PaginatedResource;
import com.ksoot.airline.common.util.pagination.PaginatedResourceAssembler;
import com.ksoot.airline.domain.service.MongoAuditHistoryService;
