package com.ksoot.airline.common.util.rest.response;

import com.ksoot.airline.common.util.rest.response.builder.AbstractResponseBuilder;
import com.ksoot.airline.common.util.rest.response.builder.BodyBuilder;
import com.ksoot.airline.common.util.rest.response.builder.HeaderBuilder;
import com.ksoot.airline.common.util.rest.response.builder.StatusBuilder;
import java.net.URI;
