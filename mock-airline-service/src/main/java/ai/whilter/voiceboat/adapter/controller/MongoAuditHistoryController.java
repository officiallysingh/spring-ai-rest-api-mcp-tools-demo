...
import static ai.whilter.voiceboat.common.CommonConstants.DEFAULT_PAGE_SIZE;
import static ai.whilter.voiceboat.common.util.rest.ApiConstants.INTERNAL_SERVER_ERROR_EXAMPLE_RESPONSE;

import ai.whilter.voiceboat.common.mongo.AuditEvent;
import ai.whilter.voiceboat.common.util.pagination.PaginatedResource;
import ai.whilter.voiceboat.common.util.pagination.PaginatedResourceAssembler;
import ai.whilter.voiceboat.domain.service.MongoAuditHistoryService;
