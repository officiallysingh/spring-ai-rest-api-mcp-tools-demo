package ai.whilter.voiceboat.common.util.rest.response;

import ai.whilter.voiceboat.common.util.rest.response.builder.AbstractResponseBuilder;
import ai.whilter.voiceboat.common.util.rest.response.builder.BodyBuilder;
import ai.whilter.voiceboat.common.util.rest.response.builder.HeaderBuilder;
import ai.whilter.voiceboat.common.util.rest.response.builder.StatusBuilder;
import java.net.URI;
